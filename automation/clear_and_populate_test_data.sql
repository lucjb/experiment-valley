...
('a1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 5, 12.3, 85.0, 'HiPPO', 6.2),

-- Bob - Good performer vs Random
('a2222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 4, 9.8, 78.0, 'Random', 4.1),

-- Charlie - Decent performer vs Naive
('a3333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 4, 8.1, 72.0, 'Naive', 5.3),

-- Diana - Moderate performer vs HiPPO
('a4444444-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 3, 6.5, 65.0, 'HiPPO', 7.8),

-- Eve - Struggling performer vs Random
('a5555555-5555-5555-5555-555555555555', '55555555-5555-5555-5555-555555555555', 3, 5.2, 58.0, 'Random', 8.9),

-- Frank - New player vs Naive
('a6666666-6666-6666-6666-666666666666', '66666666-6666-6666-6666-666666666666', 2, 4.1, 52.0, 'Naive', 6.7),

-- Grace - Recent player vs HiPPO
('a7777777-7777-7777-7777-777777777777', '77777777-7777-7777-7777-777777777777', 1, 3.2, 45.0, 'HiPPO', 9.1),

-- Henry - Latest player vs Random
('a8888888-8888-8888-8888-888888888888', '88888888-8888-8888-8888-888888888888', 0, 1.8, 38.0, 'Random', 7.4);
